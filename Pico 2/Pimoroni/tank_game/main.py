...
def run_game():
    ...
    while True:
        ...
        if (game_state == "game_over_1"):
            ...
            display.set_pen(TEXT_COLOR)
            display.text("Game Over", 43, 33, 240, 3)
            display.text("Player 1 wins", 23, 63, 240, 3)
            #
            display.set_pen(TEXT_COLOR_ACTIVE)
            display.text("Game Over", 40, 30, 240, 3)
            display.text("Player 1 wins", 20, 60, 240, 3)            
        ...
        if (game_state == "game_over_2"):
            ...
            display.set_pen(TEXT_COLOR)
            display.text("Game Over", 43, 33, 240, 3)
            display.text("Player 2 wins", 23, 63, 240, 3)
            #
            display.set_pen(TEXT_COLOR_ACTIVE)
            display.text("Game Over", 40, 30, 240, 3)
            display.text("Player 2 wins", 20, 60, 240, 3)   
